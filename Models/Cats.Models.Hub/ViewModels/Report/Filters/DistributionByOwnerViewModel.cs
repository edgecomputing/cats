...
namespace Cats.Models.Hub.ViewModels.Report
{
    ...
    public class DistributionByOwnerViewModel
    {
        ...
        public DistributionByOwnerViewModel(List<CodesViewModel> codes,List<CommodityTypeViewModel> commodityTypes,List<ProgramViewModel> programs,List<StoreViewModel> stores,
            List<AreaViewModel> areas, List<DonorViewModel> sourceDonors,List<DonorViewModel > responsibleDonors   )
        {
            ...
            this.SourceDonors = sourceDonors;// Repository.Donor.GetAllSourceDonorForReport();
            this.ResponsibleDonors = responsibleDonors;// Repository.Donor.GetAllResponsibleDonorForReport();
        }
    }
}