...
namespace Cats.Services.EarlyWarning
{
    ...
    public class NeedAssessmentDetailService : INeedAssessmentDetailService
    {
       ...
       public int GetNeedAssessmentBeneficiaryNo(string year , string season, int woredaId)
       {
           var beneficiaryNo = _unitOfWork.NeedAssessmentDetailRepository.FindBy(w => w.NeedAssessmentHeader.NeedAssessment.NeedADate.Value.Year.ToString() == year && w.NeedAssessmentHeader.NeedAssessment.Season1.Name == season && w.Woreda == woredaId &&  w.NeedAssessmentHeader.NeedAssessment.NeedAApproved == true).SingleOrDefault();
       ...
       public int GetNeedAssessmentMonths(string year, string season, int woredaId)
       {
           var months = _unitOfWork.NeedAssessmentDetailRepository.FindBy(w => w.NeedAssessmentHeader.NeedAssessment.NeedADate.Value.Year.ToString() == year && w.NeedAssessmentHeader.NeedAssessment.Season1.Name == season && w.Woreda == woredaId && w.NeedAssessmentHeader.NeedAssessment.NeedAApproved == true).SingleOrDefault();
