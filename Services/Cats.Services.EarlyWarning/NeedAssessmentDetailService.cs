...
namespace Cats.Services.EarlyWarning
{
    ...
    public class NeedAssessmentDetailService : INeedAssessmentDetailService
    {
       ...
       public int GetNeedAssessmentBeneficiaryNo(int year , int seasonID, int woredaId)
       {
           var beneficiaryNo = _unitOfWork.NeedAssessmentDetailRepository.FindBy(w => w.NeedAssessmentHeader.NeedAssessment.NeedADate.Value.Year == year && w.NeedAssessmentHeader.NeedAssessment.Season == seasonID && w.Woreda == woredaId).SingleOrDefault();
       ...
       public int GetNeedAssessmentMonths(int year, int seasonID, int woredaId)
       {
           var months = _unitOfWork.NeedAssessmentDetailRepository.FindBy(w => w.NeedAssessmentHeader.NeedAssessment.NeedADate.Value.Year == year && w.NeedAssessmentHeader.NeedAssessment.Season == seasonID && w.Woreda == woredaId).SingleOrDefault();
