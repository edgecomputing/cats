...
namespace Cats.Areas.GiftCertificate.Models
{
    ...
    public class GiftCertificateViewModel
    {
        ...
        /// <returns></returns>
        public static Models.GiftCertificateViewModel GiftCertificateModel(Cats.Models.GiftCertificate GiftCertificateModel)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Cats.Models.GiftCertificate GenerateGiftCertificate()
        {
            Cats.Models.GiftCertificate giftCertificate = new Cats.Models.GiftCertificate()
                                                  {
